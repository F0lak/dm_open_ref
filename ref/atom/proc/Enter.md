...
> [!NOTE]
> The following behavior only applies to <a class="code" href="#/world/var/movement_mode">LEGACY_MOVEMENT_MODE</a>. In all other movement modes, the turf's contents are not taken into account. Only the result of turf.Cross() matters.
