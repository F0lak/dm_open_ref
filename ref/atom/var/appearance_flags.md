...
The value of [`client.color`](/client/var/color) is
...
The [`mouse_opacity`](/atom/var/mouse_opacity) set by the
...
would be in [`TILE_MOVEMENT_MODE`](/world/var/movement_mode),
