...
### NO_CLIENT_COLOR    
The value of [client.color](/ref/client/var/color/color.md){.code} is normally    
...
The [mouse_opacity](/ref/atom/var/mouse_opacity/mouse_opacity.md){.code} set by the plane    
...
in [TILE_MOVEMENT_MODE](/ref/world/var/movement_mode/movement_mode.md){.code}, regardless of    
