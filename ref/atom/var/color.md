...
**Possible values:**
*   null (white)
*   any [color](/ref/%7B%7Bappendix%7D%7D/html-colors.md) -m generated by `rgb()`
    (e.g., `"#00ff00"` for green)
*   a [color matrix](/ref/%7Bnotes%7D/color-matrix.md) -m (in list form)
...
[color matrix](/ref/%7Bnotes%7D/color-matrix.md) -m which is a list of values.
