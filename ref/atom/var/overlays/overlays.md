...
changes you may prefer to look into [image objects](/ref/image/image.md) (which can    
also be selectively shown to only certain players) or [visual    
contents](/ref/atom/var/vis_contents/vis_contents.md) which are more versatile.    
:::    
...
they are stored in a [special internal format](/ref/atom/var/appearance/appearance.md).    
