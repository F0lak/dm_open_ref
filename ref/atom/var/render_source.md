...
Note: Any mouse hits on this object belong to the object itself, not to the object used in the `render_source` or its children. If you want mouse clicks and other behavior to go to the source, use the `PASS_MOUSE` <a href="#/atom/var/appearance_flags">appearance flag</a>.
***
**Related Pages:**
