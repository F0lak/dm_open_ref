...
[`KEEP_TOGETHER`](/ref/atom/var/appearance_flags/appearance_flags.md) flag to group all of the    
icons together, those will also be included in the slate.    
If the render target is a [`PLANE_MASTER`](/ref/atom/var/appearance_flags/appearance_flags.md),    
