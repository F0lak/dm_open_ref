...
+   empty list
***
This is a list of icons which are displayed underneath the object's main icon. Since these are basically the same as overlays, see <a href="#/atom/var/overlays">overlays</a> for more detailed information.
