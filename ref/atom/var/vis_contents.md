...
You can alter some aspects of how an object behaves when in visual contents by changing its <a class="code" href="#/atom/var/vis_flags">vis_flags</a> var. In particular this is useful if you want an object to behave more like an overlay, inheriting aspects of its parent object or even acting like a part of that object instead of an independent one. Also this can make an object act like an underlay instead of an overlay when using a floating layer.
...
Being in a visual contents list counts as a <a href="#/DM/garbage">reference</a> for anything in the list, the same way that being on the map or inside of a movable counts as a reference.
***
**Related Pages:**
