...
## color (var)
***
Casts a color multiplication or <a href="#/{notes}/color-matrix">matrix</a> effect over the entire main map. This behaves exactly the same as atom.color, and will be combined with atom.color (which comes first) where present. See <a href="#/atom/var/color">atom.color</a> for more information.
