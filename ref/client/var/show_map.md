...
The following example shows one useful combination of settings. Note that setting <code>world.view=-1</code> also disables the map, but it also sets the default value of the <code>view()</code> depth in such a way as to always return an empty list.
