...
After a query is executed, calling Add() to create new query text will clear out the old
...
> +   [RowsAffected proc (database query)][/ref/database/query/proc/RowsAffected.md]