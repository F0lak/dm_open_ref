...
If you don't specify the parent_type for an object defined at the top level, it defaults to <a href="#/datum">/datum</a>, which (with just a couple exceptions) is the ultimate ancestor of all object types. You could use that fact to define procedures or variables that you need all of your objects to share.
