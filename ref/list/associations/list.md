...
:   [list proc](/ref/proc/alist/alist.md)    
:   [list2params proc](/ref/proc/list2params/list2params.md)    
:   [params var (world)](/ref/world/var/params/params.md)    
...
associations. See [alist()](/ref/list/alist/alist.md){.code} for more information.)    
...
`params["time"]`.    
The [list()](/ref/proc/list/list.md){.code} or [alist()](/ref/proc/alist/alist.md){.code}    
...
The [`alist` proc](/ref/proc/alist/alist.md) creates lists that are *strictly*    
