...
If [world.movement_mode](/ref/world/var/movement_mode){.code} is set to    
...
[TILE_MOVER](/ref/atom/var/appearance_flags){.code} appearance flag.    
### Bounding boxes    
::: {.sidebar .embed-image}    
...
[world.movement_mode](/ref/world/var/movement_mode){.code}; in legacy mode,    
...
client uses a higher [fps](/ref/client/var/fps){.code} than the server.    
### Pixel procs    
