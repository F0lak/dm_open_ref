...
If [world.movement_mode](/ref/world/var/movement_mode/movement_mode.md){.code} is set to    
...
[TILE_MOVER](/ref/atom/var/appearance_flags/appearance_flags.md){.code} appearance flag.    
### Bounding boxes    
::: {.sidebar .embed-image}    
...
[world.movement_mode](/ref/world/var/movement_mode/movement_mode.md){.code}; in legacy mode,    
...
client uses a higher [fps](/ref/client/var/fps/fps.md){.code} than the server.    
### Pixel procs    
