...
When using this special layer, it should be added to the layer an atom normally
...
This can be mixed with EFFECTS_LAYER. Anything in TOPDOWN_LAYER will display
