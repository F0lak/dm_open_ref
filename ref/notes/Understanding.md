...
Every atom has an [appearance](/ref/atom/var/appearance.md) that holds all of    
...
[icon](/ref/atom/var/icon.md){.code} and    
...
:::    
::::::::::    
The [underlays](/ref/atom/var/underlays.md){.code} list is processed first,    
then [overlays](/ref/atom/var/overlays.md){.code}. These lists contain    
...
Any atom can have an [image object](/ref/image.md) attached, which can be    
shown to only specific players. Most atoms, and image objects, can have    
[visual contents](/ref/atom/var/vis_contents.md) that display other atoms as    
if they\'re overlays.    
:::::::: renderlist    
::: renderlist-box    
Underlays    
...
Any appearance may have [maptext](/ref/atom/var/maptext.md){.code} attached.    
...
[plane](/ref/atom/var/plane.md){.code} than the group\'s owner, it will be    
...
targets](/ref/atom/var/render_target.md) and special map formats. Any details    
