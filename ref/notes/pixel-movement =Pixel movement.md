...
If [`world.movement_mode`](/world/var/movement_mode) is
...
[`TILE_MOVER`](/atom/var/appearance_flags) appearance flag.
### Bounding boxes
::* {.sidebar .embed-image}
...
on [`world.movement_mode`](/world/var/movement_mode); in legacy
...
[`fps`](/client/var/fps) than the server.
### Pixel procs
