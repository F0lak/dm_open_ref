...
If [world.movement_mode](/ref/world/var/movement_mode.md) {.code} is
...
on [world.movement_mode](/ref/world/var/movement_mode.md) {.code}; in legacy
...
[fps](/ref/client/var/fps.md) .code} than the server.
### Pixel procs
