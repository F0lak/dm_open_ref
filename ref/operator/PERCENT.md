...
If A is a vector, its components are treated as integers; B can also be a vector in this case, and its components are also treated as integers. The result is a new vector.

If A is a pixloc, it's treated like a 2D vector and the modulo operation is done with that instead.
***
**Related Pages:**
