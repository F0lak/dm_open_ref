...
**Arguments:**
+   Ref:    A turf, obj, mob, pixloc, or a pair of pixlocs as two arguments.
...
Calling bounds() will default to bounds(src,0), if src is a turf, obj, or mob. This returns all turfs, objs, and mobs (including src) within src's bounding box. If a single pixloc is used for Ref, it will have no width or height; you can use a pair of pixlocs instead to get a block between two pixlocs.
...
Note: A <a href="#/vector">vector</a> may be used in place of any x/y or width/height pair.
***
**Related Pages:**
