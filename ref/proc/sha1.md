...
Note that you must pass the result of <a class="code" href="#/proc/file">file()</a> in order to compute the hash of an external file's contents at runtime. Otherwise `sha1()` will treat the filename as text and return the hash of the name only.
