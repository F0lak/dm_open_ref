...
The following example shows how to export and later import a savefile. The user's mob is written into a directory with the same name as their <a href="#/mob/var/ckey">ckey</a> and the result is written to a text file.
...
mob/verb/write()
   ...
   usr << "[html_encode(file2text(txtfile))]"
