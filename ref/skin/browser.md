...
:   [auto-format](/ref/%7Bskin%7D/param/auto-format/auto-format.md)    
:   [on-hide](/ref/%7Bskin%7D/param/on-hide/on-hide.md)    
:   [on-show](/ref/%7Bskin%7D/param/on-show/on-show.md)    
:   [show-history](/ref/%7Bskin%7D/param/show-history/show-history.md)    
:   [show-url](/ref/%7Bskin%7D/param/show-url/show-url.md)    
:   [use-title](/ref/%7Bskin%7D/param/use-title/use-title.md)    
...
[browse()](/ref/proc/browse/browse.md){.code} proc. Since the advent of skins in    
...
[window control](/ref/%7Bskin%7D/control/main/main.md), and within that window    
there will be a new browser control simply called `browser`.    
If you want to interact with the new browser, its full \"decorated\"    
[id](/ref/%7Bskin%7D/param/id/id.md){.code} is *`windowname`*`.browser`.    
### Running JavaScript from DM    
Sending [output()](/ref/proc/output/output.md){.code} to a browser will send a    
...
which is why [url_encode()](/ref/proc/url_encode/url_encode.md){.code} is wrapped around    
the [json_encode()](/ref/proc/json_encode/json_encode.md){.code} call in this example.    
### More browser options    
These topics cover more advanced uses of the browser control.    
[winset and winget (JavaScript)](/ref/%7Bskin%7D/control/browser/winset/winset.md)    
:   Interact with the skin via JavaScript    
[byondStorage (browser control)](/ref/%7Bskin%7D/control/browser/byondStorage/byondStorage.md)    
