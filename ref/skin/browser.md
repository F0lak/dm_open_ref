...
Sending [output()](/ref/proc/output.md){.code} to a browser will send a    
...
which is why [url_encode()](/ref/proc/url_encode.md){.code} is wrapped around    
the [json_encode()](/ref/proc/json_encode.md){.code} call in this example.    
...
[byondStorage (browser control)](/ref/%7Bskin%7D/control/browser/byondStorage.md)    
