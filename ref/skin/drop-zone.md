...
<!-- -->    
**Default value:**    
:   `true` for [Grid](/ref/%7Bskin%7D/control/grid/grid.md),    
    [Info](/ref/%7Bskin%7D/control/info/info.md), [Map](/ref/%7Bskin%7D/control/map/map.md)    
...
[MouseDrop()](/ref/client/proc/MouseDrop/MouseDrop.md){.code} if you drop an atom here.    
...
[is-list](/ref/%7Bskin%7D/param/is-list/is-list.md){.code} is true) when dragging    
to/from a grid cell.    
