...
<!-- -->
**Default value:**
*   `true` for [Grid](/ref/%7Bskin%7D/control/grid.md) -m,
    [Info](/ref/%7Bskin%7D/control/info.md) -m, [Map](/ref/%7Bskin%7D/control/map.md) -m
...
[MouseDrop()](/ref/client/proc/MouseDrop.md) -m{.code} if you drop an atom here.
...
[is-list](/ref/%7Bskin%7D/param/is-list.md) -m.code} is true) when dragging
to/from a grid cell. 
