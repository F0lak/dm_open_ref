[]{#/{skin}/param}    
## parameters (skin)    
Controls can be interacted with via [winset()](/ref/proc/winset.md){.code} and    
[winget()](/ref/proc/winset.md){.code} to change or read various parameters.    
...
The list of [all controls](/ref/%7Bskin%7D/control.md) which shows which    
