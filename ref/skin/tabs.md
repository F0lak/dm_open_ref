...
:   [multi-line parameter](/ref/%7Bskin%7D/param/multi-line/multi-line.md)    
<!-- -->    
**Applies to:**    
...
**Format:**    
:   string    
A comma-separated list of [id](/ref/%7Bskin%7D/param/id/id.md){.code} values for    
...
Note: When using this with [winset()](/ref/proc/winset/winset.md){.code}, remember    
you will need to escape `+` as `%2B` via    
[url_encode()](/ref/proc/url_encode/url_encode.md){.code} or    
[list2params()](/ref/proc/list2params/list2params.md){.code}.  