...
## IsBanned proc (world)    
**See also:**    
:   [GetConfig proc (world)](ref/world/proc/GetConfig)    
:   [params2list proc](ref/proc/params2list)    
:   [address var (client)](ref/client/var/address)    
:   [computer_id var (client)](ref/client/var/computer_id)    
:   [connection var (client)](ref/client/var/connection)    
...
:   type: type of connection if known (see    
    [client.connection](ref/client/var/connection))    
...
[application/x-www-form-urlencoded](ref/proc/list2params) format, it is    
...
[GetConfig](ref/world/proc/GetConfig) and    
[SetConfig](ref/world/proc/SetConfig) to read and write the data. Extra    
