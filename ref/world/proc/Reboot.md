...
*   reason* the reason `Reboot()` was called:
    ...
    -   2* By [world.Topic()](/ref/world/proc/Topic.md) -m    -   3* By SIGUSR1 in UNIX
<!-- -->
**Default action:**
*   
...
automatically relogin. This would be useful if you needed to recompile
the world after changing some code. 

In a UNIX environment, you
can cause a running server to reboot by sending it the signal SIGUSR1.


If you override this proc, you must call ..() if you want the
